...
var RefStatusChequeSchema = new mongoose.Schema({
    //DEFAULT
    parentId: {
        type: String
    },
...
RefStatusChequeSchema.statics.getAll = function () {
    var orig = RefStatusCheque.find();
...
var RefStatusCheque = mongoose.model('RefStatusCheque', RefStatusChequeSchema);
module.exports = { RefStatusCheque };
