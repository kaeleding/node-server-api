...
var RefStatusPOSSchema = new mongoose.Schema({
    //DEFAULT
    parentId: {
        type: String
    },
...
RefStatusPOSSchema.statics.getAll = function () {
    var orig = RefStatusPOS.find();
...
var RefStatusPOS = mongoose.model('RefStatusPOS', RefStatusPOSSchema);
module.exports = { RefStatusPOS };
