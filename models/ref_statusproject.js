...
var RefStatusProjectSchema = new mongoose.Schema({
    //DEFAULT
    parentId: {
        type: String
    },
...
RefStatusProjectSchema.statics.getAll = function () {
    var orig = RefStatusProject.find();
...
var RefStatusProject = mongoose.model('RefStatusProject', RefStatusProjectSchema);
module.exports = { RefStatusProject };
